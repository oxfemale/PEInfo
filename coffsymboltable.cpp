...
COFFSymbol::GetStorageClassName()
{
	...
	switch( storageClass )
	{
		case IMAGE_SYM_CLASS_END_OF_FUNCTION: return (PSTR)"END_OF_FUNCTION";
		case IMAGE_SYM_CLASS_NULL: return (PSTR)"NULL";
		case IMAGE_SYM_CLASS_AUTOMATIC: return (PSTR)"AUTOMATIC";
		case IMAGE_SYM_CLASS_EXTERNAL: return (PSTR)"EXTERNAL";
		case IMAGE_SYM_CLASS_STATIC: return (PSTR)"STATIC";
		case IMAGE_SYM_CLASS_REGISTER: return (PSTR)"REGISTER";
		case IMAGE_SYM_CLASS_EXTERNAL_DEF: return (PSTR)"EXTERNAL_DEF";
		case IMAGE_SYM_CLASS_LABEL: return (PSTR)"LABEL";
		case IMAGE_SYM_CLASS_UNDEFINED_LABEL: return (PSTR)"UNDEFINED_LABEL";
		case IMAGE_SYM_CLASS_MEMBER_OF_STRUCT: return (PSTR)"MEMBER_OF_STRUCT";
		case IMAGE_SYM_CLASS_ARGUMENT: return (PSTR)"ARGUMENT";
		case IMAGE_SYM_CLASS_STRUCT_TAG: return (PSTR)"STRUCT_TAG";
		case IMAGE_SYM_CLASS_MEMBER_OF_UNION: return (PSTR)"MEMBER_OF_UNION";
		case IMAGE_SYM_CLASS_UNION_TAG: return (PSTR)"UNION_TAG";
		case IMAGE_SYM_CLASS_TYPE_DEFINITION: return (PSTR)"TYPE_DEFINITION";
		case IMAGE_SYM_CLASS_UNDEFINED_STATIC: return (PSTR)"UNDEFINED_STATIC";
		case IMAGE_SYM_CLASS_ENUM_TAG: return (PSTR)"ENUM_TAG";
		case IMAGE_SYM_CLASS_MEMBER_OF_ENUM: return (PSTR)"MEMBER_OF_ENUM";
		case IMAGE_SYM_CLASS_REGISTER_PARAM: return (PSTR)"REGISTER_PARAM";
		case IMAGE_SYM_CLASS_BIT_FIELD: return (PSTR)"BIT_FIELD";
		case IMAGE_SYM_CLASS_FAR_EXTERNAL: return (PSTR)"FAR_EXTERNAL";
		case IMAGE_SYM_CLASS_BLOCK: return (PSTR)"BLOCK";
		case IMAGE_SYM_CLASS_FUNCTION: return (PSTR)"FUNCTION";
		case IMAGE_SYM_CLASS_END_OF_STRUCT: return (PSTR)"END_OF_STRUCT";
		case IMAGE_SYM_CLASS_FILE: return (PSTR)"FILE";
		case IMAGE_SYM_CLASS_SECTION: return (PSTR)"SECTION";
		case IMAGE_SYM_CLASS_WEAK_EXTERNAL: return (PSTR)"WEAK_EXTERNAL";
		case IMAGE_SYM_CLASS_CLR_TOKEN: return (PSTR)"CLR_TOKEN";
		default: return (PSTR)"???";
	}
}
